...
if(isset($_POST["comentario"]) && producto_comprado($_SESSION['id_cliente'],$nombre_producto,$conexion)==true && valoracion_repetida($_SESSION['id_cliente'],$_POST['id_producto'],$conexion)==false && (contar_caracteres($_POST["comentario"])<500)){
	...
	$sql="INSERT INTO comentarios 	(nombre,comentario,puntuacion,correo,url,id_cliente,id_producto) VALUES 	('$nombre','$comentario',$n_estrellas,$correo,'$url',$id_cliente,$id_producto)";
	mysqli_query($conexion,$sql) or die(mysqli_error($conexion));
	cerrarconexion();
	header(	"location:../detalleproducto.php?id_producto=$id_producto&id_producto=$id_producto&enviado=1");
