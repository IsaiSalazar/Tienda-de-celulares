...
?>
   ...
   <!-- --------------- stock ------------------------ --> 
	...
	<td><a href="formaniadirproductos.php?id_producto=<?php echo $fila1['id_producto']; ?>&pagina=<?php echo $pagina; ?>"><button type="button" class="btn btn-success">Agregar</button></a></td>
