...
include('../../php/conexion.php');
	...
	$registros2=mysqli_query($conexion,"select marca from marcas where id='$fila1[id_marca]'") or die ("Error al conectar con la tabla".mysql_error($conexion));
	...
	echo "<br><br><b>marca:</b> ".utf8_encode($fila2['marca'])."<br><br>";
