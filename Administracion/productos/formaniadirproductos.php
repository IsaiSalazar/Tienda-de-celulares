...
function validarformulario(){
	...
	if(document.formproductos.marca.value==""){
		...
		$("#avisomarca").show("fast");
		document.formproductos.marca.style.border="1px solid red";
		
		}
		
	if(document.formproductos.nombre.value!="" && document.formproductos.precio.value!="" && document.formproductos.descripcion.value!="" && document.formproductos.marca.value!=""){
...
<ul id="css3menu1" class="topmenu">
	...
	<li class="topmenu"><a href="../marcas/formanadirmarcas.php" style="width:180px;height:55px;line-height:55px;"><span style="margin-top:-15px"><span style="margin-top:-15px">marcas</span></a></li>
...
<!-- campo precio -->   
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input onkeyup="validadoprecio()" type="number" step="0.1" min="0" class="form-control" id="inputEmail3" placeholder="Precio producto (Ejemplo 154.50)" name="precio">
    </div>
  </div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
    <select onkeyup="validadomarca()" class="form-control" name="marca">
<?php while($fila=mysqli_fetch_array($registros)) { ?>
 <option value="<?php echo $fila['id']; ?>"><?php echo utf8_encode($fila['marca']); ?></option>
<?php } ?>
</select>
    </div>
  </div>
    ...
    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span   aria-hidden="true">&times;</span></button>
    <p class="centrar">No has añadido ninguna categoría <a target="_blank" href="../marcas/formaniadirmarcas.php">Añadir Categoría</a></p>
    </div>
