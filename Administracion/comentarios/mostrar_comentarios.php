...
//paginador
 ...
 $registros2=mysqli_query($conexion,"SELECT id_comentario,fecha,comentario,puntuacion,id_cliente,id_producto,id_marca,estado FROM comentarios ORDER BY id_comentario DESC LIMIT ".$inicio."," .$TAMANO_PAGINA) or die(mysqli_error($conexion));
// paginador
...
<ul id="css3menu1" class="topmenu">
	...
	<li class="topmenu"><a href="../marcas/formmarcas.php" style="width:180px;height:55px;line-height:55px;"><span style="margin-top:-15px"><span style="margin-top:-15px">marcas</span></a></li>
...
while($fila2=mysqli_fetch_array($registros2)){
	...
	$registros5=mysqli_query($conexion,"SELECT marca FROM marcas WHERE id='$fila2[id_marca]'");
...
?>
   <tr class="active">
        ...
        <td><?php echo utf8_encode($fila5["marca"]); ?></td>
        <?php
        if($fila2["estado"]==0){
		?>
        	<td>
